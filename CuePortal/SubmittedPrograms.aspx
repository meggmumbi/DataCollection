<%@ Page Title="" Language="C#" MasterPageFile="~/AccreditationMaster.Master" AutoEventWireup="true" CodeBehind="SubmittedPrograms.aspx.cs" Inherits="CicPortal.SubmittedPrograms" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        <div class="row">
            ...
            <div class="panel-heading">Submitted Programs</div>
                    ...
                    <div id ="feedback" runat="server"></div>
                     <table class="table table-bordered table-striped table-hover" id="dataTables-example">
                         ...
                         <%
                             ...
                             var requests = nav.ProgramAccreditation.Where(r => r.Institution_No== Convert.ToString(Session["UniversityCode"]) && r.Status != "Open");
                             ...
                             <tr>
                                 ...
                                 <td><%=request.Program_Level %></td>
                                  <td><%=status %></td>
                                  <td><a class="btn btn-success" href="DownLoadProgramme.aspx?accreditationNo=<%=request.Accreditation_No %>" ><i class="fa fa-download"></i> Preview / Print</a></td>
                             </tr>
                             <%
                            }
                         %>
