<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/DataCollectionMaster.Master" CodeBehind="StudentsPublications.aspx.cs" Inherits="CicPortal.StudentsPublications" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-6">
                <div class="panel panel-default">
                    <p>*Please Click Download Students Publications Template to download formatted excel template file</p>
                    <div class="panel-heading">Excel Upload</div>

                    <div class="panel-body">
                        <a href="templates/Students Innovations.xlsx"><i class="fa fa-file-excel-o"></i>Download Students  Publications Template</a>
            ...
            <div class="col-md-6 col-lg-6">
                <p>*Please Click Add Publications to Add Students  Publications details manually</p>
                <div class="panel panel-default">

                    <div class="panel-heading">Form Upload</div>
                    <div class="panel-body">
                        <label class="btn btn-success" data-toggle="modal" data-target="#form-input"><i class="fa fa-plus fa-fw"></i>Add Students Publication</label>
                    </div>
                </div>
        ...
        <div class="panel panel-default">
            <p>*List of all Uploaded Students  Publications</p>
            <div class="panel-heading">Students  Publications</div>
            <div class="panel-body">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add Students Publication</h4>
                </div>
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                         <div class="col-md-6 col-lg-6">
                            <p>*Please enter the student publication year</p>
                            <div class="form-group"><strong>Year Published:</strong><asp:TextBox runat="server" CssClass="form-control" Placeholder="Year Published" ID="patentYear" />
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6" id="mPublicationType">
                            <p>*Please select student  publications type</p>
                            <div class="form-group"><strong>Publication Type:</strong><asp:DropDownList runat="server" CssClass="form-control" ID="publicationType" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            <p>*Please enter student publicatons Title</p>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            <p>*Please enter active student publications Link address</p>
                            <div class="form-group"><strong>Link to Publication:</strong><asp:TextBox runat="server" CssClass="form-control" placeholder="Link to Publication" ID="link" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-lg-6">
                            <p>*Please enter the student pubication Publisher Name</p>
                            <div class="form-group"><strong>Publisher:</strong><asp:TextBox runat="server" CssClass="form-control" Placeholder="Publisher" ID="patentingOrganisation" />
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6">
                            <p>*Please enter the student Publication DOI Number</p>
                            <div class="form-group"><strong>DOI No:</strong><asp:TextBox runat="server" CssClass="form-control" ID="copyrightNo" PlaceHolder="DOI No" />
                            </div>
                        </div>
                    </div>
                    <div class="row">                       
                        <div class="col-md-12 col-lg-12">
                            <p>*Please enter the student Publication Author Ids in the order in which they appear in the Publication separated by Commas</p>
                ...
                <div class="panel-body">
                    <table class="table table-bordered table-striped dataTable" >
                        ...
                        <%
                             ...
                             var universityresearches = nav.Research.Where(r => r.university == Convert.ToString(Session["UniversityCode"])&&r.Researcher_Category=="Student"&&r.Category=="Publication");
                    ...
                    <table class="table table-bordered table-striped dataTable2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><% = nav.Research.Where(r => r.university == Convert.ToString(Session["UniversityCode"])&&r.Researcher_Category=="Student" &&r.Category=="Publication"&& r.Campus == campus.No).ToList().Count %></td>
                            </tr>
                            <%
   ...
   <div id="deleteStudentPublicationModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Confirm Deleting Students Publication</h4>
                </div>
                <div class="modal-body">
                    <p>Are you sure you want to delete the Student Publication <strong id="publicationtitle"></strong>?</p>
    ...
    <script>
        $(document).ready( function () {
            new ExcelUploader({
                ...
                receiverUrl: ["addStudentsPublication"],
    ...
    <script>
        function loadData() {
            ...
            if (userType == "Data Officer") {
              $.ajax({
                  url: "<% =Config.Receiver() %>/getStudentsResearch?type=Publication&&userCode=<% = Session["Code"] %>&&password=<% =Session["Password"] %>",
                  type: "GET",
        ...
        function deleteStudentsResearch(id, title) {
            ...
            $("#deleteStudentPublicationModal").modal();
        }
