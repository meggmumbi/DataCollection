<%@ Page Title="" Language="C#" MasterPageFile="~/AccreditationMaster.Master" AutoEventWireup="true" CodeBehind="ProgrammeReSubmission.aspx.cs" Inherits="CicPortal.ProgrammeReSubmission" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        <div class="row">
            ...
            <div class="panel-heading">Request For Submission Applications</div>
                    ...
                    <div id ="feedback" runat="server"></div>
                     <table class="table table-bordered table-striped table-hover" id="dataTables-example">
                         ...
                         <%
                             ...
                             var requests = nav.ProgramAccreditation.Where(r => r.Institution_No== Convert.ToString(Session["UniversityCode"])&&r.Status=="Open"); // && r.Resubmission_Request == true
                             ...
                             <tr>
                                 ...
                                 <td><%=request.Program_Level %></td>
                                  <td><%=status %></td>
                                  <td><a class="btn btn-success" href ="ProgramAccreditation.aspx?accreditationNo=<%=request.Accreditation_No %>&step=1" ><i class="fa fa-edit"></i> Re-Submit Programme</a></td>
                             </tr>
                             <%
                            }
                         %>
