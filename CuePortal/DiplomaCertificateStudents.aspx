<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/DataCollectionMaster.Master"  CodeBehind="DiplomaCertificateStudents.aspx.cs" Inherits="CicPortal.DiplomaCertificateStudents" %>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6">
                      <a href="templates/Diploma_Certificate_Programmes_Data_Capture_Template.xlsx"><i class="fa fa-file-excel-o"></i>Download  Diploma and Certificate Students Data Template</a>
            ...
            <tbody>
                <%
                    try
                    {
                        ...
                        universityNumber = universityNumber.Replace(':', '_');
                        String documentDirectory = filesFolder + universityNumber + "/"+"DiplomaStudents/";
                        int filecounter = 0;
