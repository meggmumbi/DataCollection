...
namespace CicPortal
{
    public partial class Organogram : System.Web.UI.Page
    {
        ...
        protected void upload_Click(object sender, EventArgs e)
        {
            ...
            universityNo = universityNo.Replace(':', '_');
            String documentDirectory = filelocations + universityNo + "/" +"Organogram/";
            string myName = "";
                    ...
                    if (Directory.Exists(filelocations))
                    {
                        ...
                        if (createDirectory)
                        {
                            if (new Config().IsAllowedExtension(organorgramExtension))
                            {
                                ...
                                string organorgramFile =  Session["UniversityCode"] + "_Organogram_" + organorgram.FileName;
                                ...
                                {
                                    feedback.InnerHtml =
                                        "<div class='alert alert-success'>The University Organogram document was successfully uploaded. <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a></div>";
                                }
                                else
                                {
                                    feedback.InnerHtml =
        ...
        protected void deleteFile_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (File.Exists(myFile))
                {
                    ...
                    if (File.Exists(myFile))
                    {
                        feedback.InnerHtml = "<div class='alert alert-danger'>The University Organogram file  could not be deleted <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a></div>";
                    }
                    else
                    {
                        feedback.InnerHtml = "<div class='alert alert-success'>The University Organogram file was successfully deleted <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a></div>";
                    }
                }
                else
                {
