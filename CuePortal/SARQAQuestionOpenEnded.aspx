<%@ Page Title="" Language="C#" MasterPageFile="~/QAMaster.Master" AutoEventWireup="true" CodeBehind="SARQAQuestionOpenEnded.aspx.cs" Inherits="CicPortal.SARQAQuestionOpenEnded" %>
        ...
        <div class="panel-body">
            ...
            <div class="col-md-12 col-lg-12">
                <div class="form-group">
                    ...
                    <asp:TextBox runat="server" ID="questionname" CssClass="form-control" placeholder="Enter your answer here" TextMode="MultiLine" Height="250px" />
