<%@ Page Title="" Language="C#" MasterPageFile="~/QAMaster.Master" AutoEventWireup="true" CodeBehind="ProgrammeAuditRequisitions.aspx.cs" Inherits="CicPortal.ProgrammeAuditRequisitions" %>
    ...
    <div>
        <div class="row">
            ...
            <div class="panel-heading">Open Audit Invitations</div>
                     ...
                     <table class="table table-striped table-bordered table-hover"  id="dataTables-example">
                       <thead>
                         ...
                         <%
                             ...
                             var programs = nav.AuditRequisitionHeader.Where(r => r.Insitution_Programme_No == Convert.ToString(Session["UniversityCode"]) &&r.Published == true && r.Document_Type == "Engagement" && r.Task_Type == "Programme Quality Audit");
               ...
               <asp:Button runat="server" style="margin-left:2%" CssClass="btn btn-warning" Text="Go To Homepage" ID="gotohomepage" OnClick="gotohomepage_Click1"/>
                <br />
                <br />
                <br />
           </div>
