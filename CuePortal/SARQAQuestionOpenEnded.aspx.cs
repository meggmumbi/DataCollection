...
namespace CicPortal
{
    public partial class SARQAQuestionOpenEnded : System.Web.UI.Page
    {
        ...
        protected void save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string status = new Config().ObjNav().FnSaveAuditOpenEnded(SARNo, lineno, sectionCode, questionCode, tquestionname, "");
