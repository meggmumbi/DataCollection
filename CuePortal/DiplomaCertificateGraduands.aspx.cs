...
namespace CicPortal
{
    public partial class DiplomaCertificateGraduands : System.Web.UI.Page
    {
        ...
        protected void upload_Click(object sender, EventArgs e)
        {
            ...
            universityNo = universityNo.Replace(':', '_');
            String documentDirectory = filelocations + universityNo + "/" + "DiplomaStudentsGraduands/";
            string myName = "";
                    ...
                    if (Directory.Exists(filelocations))
                    {
                        ...
                        if (createDirectory)
                        {
                            if (new Config().IsAllowedExtension(organorgramExtension))
                            {
                                ...
                                string organorgramFile = Session["UniversityCode"] + "_DiplomaStudentsGraduands_" + organorgram.FileName;
