<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/DataCollectionMaster.Master" CodeBehind="LibraryStaffArchives.aspx.cs" Inherits="CicPortal.LibraryStaffArchives" %>
...
<div class="row">
 ...
 <div class="row">
        <div class="col-md-12 col-lg-12">
             <div class="panel panel-green">
                <div class="panel-heading">
                   Approved University Library Staff List
                </div>
                <div class="panel-body">
                    ...
                    <%
                        ...
                        string AllData = new Config().ObjNav().FnGetLibraryStaff(UniversityCode);
