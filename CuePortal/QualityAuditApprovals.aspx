<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/QAMaster.Master"  CodeBehind="QualityAuditApprovals.aspx.cs" Inherits="CicPortal.QualityAuditApprovals" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <!-- 
            if user is a data collection clerk and no request is pending approval
            -->
        <%
        ...
        <asp:Button runat="server" CssClass="btn btn-success " Text="Send Quality Audit Approval Request" ID="sendApproval" OnClick="sendApproval_Click"/>
        <div class="clearfix">
