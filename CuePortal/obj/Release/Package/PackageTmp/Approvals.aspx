<%@ Page Title="" Language="C#" MasterPageFile="~/DataCollectionMaster.Master" AutoEventWireup="true" CodeBehind="Approvals.aspx.cs" Inherits="CicPortal.Approvals" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <asp:Button runat="server" CssClass="btn btn-success " Text="Send Data Submission Approval Request" ID="sendApproval" OnClick="sendApproval_Click"/>
        <div class="clearfix">
