<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/DataCollectionMaster.Master"  CodeBehind="StaffResearchArchives.aspx.cs" Inherits="CicPortal.StaffResearchArchives" %>
...
<div class="row">
 ...
 <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="panel panel-green">
                <div class="panel-heading">
                Approved University Staff Research 
                </div>
                <div class="panel-body">
                    <table class="table table-bordered table-striped dataTable2">
                        ...
                        <tbody>
                            <%
                                var studentsresearches = nav.Research.Where(r => r.university == Convert.ToString(Session["UniversityCode"])&&r.Approval_Status=="Approved" &&r.Researcher_Category=="Staff");
