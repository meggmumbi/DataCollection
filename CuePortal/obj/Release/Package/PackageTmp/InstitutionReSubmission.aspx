<%@ Page Title="" Language="C#" MasterPageFile="~/AccreditationMaster.Master" AutoEventWireup="true" CodeBehind="InstitutionReSubmission.aspx.cs" Inherits="CicPortal.InstitutionReSubmission" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        <div class="row">
            ...
            <div class="panel-heading">Request for Re-submission Applications</div>
                ...
                <%
                    ...
                    var details = nav.InstitutionAccreditation.Where(r => r.Institution_No == Convert.ToString(Session["UniversityCode"]) &&r.Status=="Open" && r.Resubmission_Request == true);
                    ...
                    <tr>
                        ...
                        <td><a href="Institution.aspx?applicationNo=<%=detail.Accreditation_No%>" class="btn btn-success"><i class="fa fa-check"></i>Re-Submit</a></td>
                    </tr>
                    <%  
                   } 
