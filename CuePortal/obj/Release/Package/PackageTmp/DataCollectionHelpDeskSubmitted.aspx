<%@ Page Title="" Language="C#" MasterPageFile="~/DataCollectionMaster.Master" AutoEventWireup="true" CodeBehind="DataCollectionHelpDeskSubmitted.aspx.cs" Inherits="CicPortal.DataCollectionHelpDeskSubmitted" %>
            ...
            <table id="example1" class="table table-striped table-bordered">
                ...
                <tbody>
                    <%
                        ...
                        string allData = new Config().ObjNav().FnGetHelpdeskRequests(unicode,userEmail);
