<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/DataCollectionMaster.Master" CodeBehind="PartTimeStaffArchive.aspx.cs" Inherits="CicPortal.PartTimeStaffArchive" %>
...
<div class="row">
 ...
 <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="panel panel-green">
                <div class="panel-heading">
                   University Approved Part Time Teaching Staff List
                </div>
                <div class="panel-body">
                    ...
                    <%
                        ...
                        string AllData = new Config().ObjNav().FnGetPartTimeTeachingStaff(UniversityCode);
