<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/DataCollectionMaster.Master" CodeBehind="StudentsInnovations.aspx.cs" Inherits="CicPortal.StudentsInnovations" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <div class="row">
            <div class="col-md-6 col-lg-6">
                <div class="panel panel-default">
                    <p>*Please click Download Students Innovations Template to download formatted innovation excel template.</p>
                    <div class="panel-heading">Excel Upload</div>

                    <div class="panel-body">
                        <a href="templates/Students Innovations.xlsx"><i class="fa fa-file-excel-o"></i>Download Students Innovations Template</a>
            ...
            <div class="col-md-6 col-lg-6">
                <div class="panel panel-default">
                    <p>*Please click Add student Innovation to add innovation details manually.</p>
                    <div class="panel-heading">Form Upload</div>
                    <div class="panel-body">
                        <label class="btn btn-success" data-toggle="modal" data-target="#form-input"><i class="fa fa-plus fa-fw"></i>Add Student Innovation</label>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="panel panel-default">
            <p>*List of All Students Uploaded innovation details</p>
    ...
    <div id="form-input" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Add Student Innovation</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                         <div class="col-md-6 col-lg-6">
                            <p>*Please select student innovation Campus</p>
                            <div class="form-group"><strong>Campus:</strong><asp:DropDownList runat="server" CssClass="form-control" ID="campus" />
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6">
                            <p>*Please select student Innovation Domain</p>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            <p>*Please enter student  Innovation Title</p>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            <p>*Please enter the active student Innovation link address</p>
                            <div class="form-group"><strong>Link to Innovation:</strong><asp:TextBox runat="server" CssClass="form-control" placeholder="Link to Innovation" ID="link" />
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6">
                            <p>*Please enter the student innovation Copyright Organisation</p>
                            <div class="form-group"><strong>Copyright Organisation:</strong><asp:TextBox runat="server" CssClass="form-control" Placeholder=" Copyright Organisation" ID="patentingOrganisation" />
                            </div>

                        </div>
                        <div class="col-md-6 col-lg-6">
                            <p>*Please enter the student innovation Copyright Number</p>
                            <div class="form-group"><strong>Copyright No:</strong><asp:TextBox runat="server" CssClass="form-control" ID="copyrightNo" PlaceHolder="Copyright No" />
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6">
                            <p>*Please enter the student innovation Copyright Year</p>
                            <div class="form-group"><strong>Copyright Year:</strong><asp:TextBox runat="server" CssClass="form-control" Placeholder="Patent/Copyright Year" ID="patentYear" />
                            </div>

                        </div>
                        <div class="col-md-12 col-lg-12">
                            <p>*Please enter the student Innovation Author Ids in the order in how they appear in the Publication separated by Commas</p>
    ...
    <div class="row">
     ...
     <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="panel panel-green">
                <div class="panel-heading">
                  University Students Innovations
                </div>
                <div class="panel-body">
                    <table class="table table-bordered table-striped dataTable" >
                        ...
                        <%
                             ...
                             var universityresearches = nav.Research.Where(r => r.university == Convert.ToString(Session["UniversityCode"])&&r.Researcher_Category=="Student"&&r.Category=="Innovation");
    ...
    %>
       <div id="deleteStudentInnovationModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Confirm Deleting Students Innovation</h4>
                </div>
                <div class="modal-body">
                    <p>Are you sure you want to delete the Staff <strong id="innovationtitle"></strong>?</p>
    ...
    <script>
        $(document).ready( function () {
            new ExcelUploader({
                ...
                receiverUrl: ["addStudentsInnovation"],
    ...
    <script>
        function loadData() {
            ...
            if (userType == "Data Officer") {
              $.ajax({
                  url: "<% =Config.Receiver() %>/getStudentsResearch?type=Innovation&&userCode=<% = Session["Code"] %>&&password=<% =Session["Password"] %>",
                  type: "GET",
        ...
        function deleteStudentsResearch(id, title) {
            ...
            $("#deleteStudentInnovationModal").modal();
        }
